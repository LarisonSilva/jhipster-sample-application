...
public class PedidoResource {
    ...
    public ResponseEntity<Pedido> partialUpdatePedido(
        ...
        Optional<Pedido> result = pedidoRepository
            ...
            .map(
                existingPedido -> {
                    if (pedido.getEfetuado() != null) {
                        existingPedido.setEfetuado(pedido.getEfetuado());
                    }
                    if (pedido.getStatus() != null) {
                        existingPedido.setStatus(pedido.getStatus());
                    }
                    if (pedido.getPrecoTotal() != null) {
                        existingPedido.setPrecoTotal(pedido.getPrecoTotal());
                    }
                    if (pedido.getComentarios() != null) {
                        existingPedido.setComentarios(pedido.getComentarios());
                    }
                    if (pedido.getCodigoPagamento() != null) {
                        existingPedido.setCodigoPagamento(pedido.getCodigoPagamento());
                    }
